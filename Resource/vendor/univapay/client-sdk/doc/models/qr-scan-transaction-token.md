...
| `paymentType` | `string` | Required, Constant | Payment method type. Always `qr_scan` for this variant.<br><br>**Value**: `'qr_scan'` | getPaymentType(): string | setPaymentType(string paymentType): void |
| `data` | [`TokenResponseQrScanData`](../../doc/models/token-response-qr-scan-data.md) | Required | Token Response Qr Scan Data schema. | getData(): TokenResponseQrScanData | setData(TokenResponseQrScanData data): void |
| `additionalProperties` | `array<string, array>` | Optional | - | findAdditionalProperty(string key): array | additionalProperty(string key, array value): void |

## Example

```php
use UnivaPay\Models\Builders\QrScanTransactionTokenBuilder;
...
$qrScanTransactionToken = QrScanTransactionTokenBuilder::init(
