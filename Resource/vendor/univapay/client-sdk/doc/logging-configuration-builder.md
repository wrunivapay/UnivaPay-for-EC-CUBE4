...
The following example uses `Monolog\Logger` implementation of `Psr\Log\LoggerInterface` for UnivapayClientSdkClient initialization.
...
$logger = new Logger('UnivapayClientSdk');
