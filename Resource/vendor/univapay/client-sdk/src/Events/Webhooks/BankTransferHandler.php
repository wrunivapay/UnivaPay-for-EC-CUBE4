...
class BankTransferHandler
{
     ...
     *
     * @return BankTransferStatusWebhookCallback|UnknownEvent The result of the event's payload parsing.
     */
    public static function parseEvent(Request $request)
    {
        ...
        try {
            return ApiHelper::getJsonHelper()->mapTypes(
                $payload,
                'oneOf{event6}(BankTransferStatusWebhookCallback{bankTransferStatusUpdated})'
            );
        } catch (Exception $_) {
