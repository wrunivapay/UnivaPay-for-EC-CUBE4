...
class CustomsHandler
{
     ...
     *
     * @return CustomsDeclarationWebhookCallback|UnknownEvent The result of the event's payload parsing.
     */
    public static function parseEvent(Request $request)
    {
        ...
        try {
            return ApiHelper::getJsonHelper()->mapTypes(
                $payload,
                'oneOf{event7}(CustomsDeclarationWebhookCallback{customsDeclarationFinished})'
            );
        } catch (Exception $_) {
