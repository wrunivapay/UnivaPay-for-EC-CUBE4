...
/**
 * Fields common to every stored transaction token, regardless of payment type. Deliberately excludes
 * `payment_type` and `data` — each concrete payment type layers those on top with `data` pinned to its
 * own shape; see `TransactionToken` for the discriminated union that ties them together.
 */
class TransactionTokenBase implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the TransactionTokenBase object to a human-readable string representation.
     *
     * @return string The string representation of the TransactionTokenBase object.
     */
