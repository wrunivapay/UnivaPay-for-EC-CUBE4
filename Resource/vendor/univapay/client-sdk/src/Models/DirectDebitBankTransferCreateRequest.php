 ...
 */
class DirectDebitBankTransferCreateRequest implements \JsonSerializable
{
    /**
     * @var int
     */
    ...
    /**
     * Converts the DirectDebitBankTransferCreateRequest object to a human-readable string representation.
     *
     * @return string The string representation of the DirectDebitBankTransferCreateRequest object.
     */
