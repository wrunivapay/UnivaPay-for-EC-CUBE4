 ...
 */
class TokenResponsePhoneNumber implements \JsonSerializable
{
    /**
     * @var int|null
     */
    ...
    /**
     * Converts the TokenResponsePhoneNumber object to a human-readable string representation.
     *
     * @return string The string representation of the TokenResponsePhoneNumber object.
     */
