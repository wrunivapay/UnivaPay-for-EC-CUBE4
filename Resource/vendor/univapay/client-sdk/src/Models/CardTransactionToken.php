 ...
 */
class CardTransactionToken implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     */
    public function __construct(TokenResponseCardData $data)
    {
        $this->data = $data;
    }
     ...
     */
    public function getData(): TokenResponseCardData
    {
        return $this->data;
    }
     ...
     * @maps data
     */
    public function setData(TokenResponseCardData $data): void
    {
        $this->data = $data;
    }

    /**
     * Converts the CardTransactionToken object to a human-readable string representation.
     *
     * @return string The string representation of the CardTransactionToken object.
     */
