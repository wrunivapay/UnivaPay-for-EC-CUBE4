 ...
 */
class CustomsDeclarationWebhookCallback implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * @var CustomsDeclarationWebhookData|null
     */
    private $data;
     ...
     *
     * @maps event
     * @factory \UnivaPay\Models\CustomsDeclarationEvent::checkValue
     */
     ...
     */
    public function getData(): ?CustomsDeclarationWebhookData
    {
        return $this->data;
    }
     ...
     * @maps data
     */
    public function setData(?CustomsDeclarationWebhookData $data): void
    {
        $this->data = $data;
    }

    /**
     * Converts the CustomsDeclarationWebhookCallback object to a human-readable string representation.
     *
     * @return string The string representation of the CustomsDeclarationWebhookCallback object.
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        $json = [];
        if (isset($this->event)) {
            $json['event']  = CustomsDeclarationEvent::checkValue($this->event);
        }
        $json['id']         = $this->id;
