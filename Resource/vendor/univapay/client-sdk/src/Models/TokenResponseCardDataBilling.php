 ...
 */
class TokenResponseCardDataBilling implements \JsonSerializable
{
    /**
     * @var array
     */
    ...
    /**
     * Converts the TokenResponseCardDataBilling object to a human-readable string representation.
     *
     * @return string The string representation of the TokenResponseCardDataBilling object.
     */
    ...
    protected $propertyNames = ['line1', 'line2', 'state', 'city', 'country', 'zip', 'phone_number'];
