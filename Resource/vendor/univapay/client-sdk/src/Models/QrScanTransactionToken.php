 ...
 */
class QrScanTransactionToken implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     */
    public function __construct(TokenResponseQrScanData $data)
    {
        $this->data = $data;
    }
     ...
     */
    public function getData(): TokenResponseQrScanData
    {
        return $this->data;
    }
     ...
     * @maps data
     */
    public function setData(TokenResponseQrScanData $data): void
    {
        $this->data = $data;
    }

    /**
     * Converts the QrScanTransactionToken object to a human-readable string representation.
     *
     * @return string The string representation of the QrScanTransactionToken object.
     */
