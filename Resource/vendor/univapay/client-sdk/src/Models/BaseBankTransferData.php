 ...
 */
class BaseBankTransferData implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the BaseBankTransferData object to a human-readable string representation.
     *
     * @return string The string representation of the BaseBankTransferData object.
     */
    ...
    protected $propertyNames = ['brand', 'expiration_period', 'expiration_time_shift'];
