 ...
 */
class BankTransferTransactionToken implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     */
    public function __construct(TokenResponseBankTransferData $data)
    {
        $this->data = $data;
    }
     ...
     */
    public function getData(): TokenResponseBankTransferData
    {
        return $this->data;
    }
     ...
     * @maps data
     */
    public function setData(TokenResponseBankTransferData $data): void
    {
        $this->data = $data;
    }

    /**
     * Converts the BankTransferTransactionToken object to a human-readable string representation.
     *
     * @return string The string representation of the BankTransferTransactionToken object.
     */
