 ...
 */
class KonbiniTransactionToken implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     */
    public function __construct(TokenResponseKonbiniData $data)
    {
        $this->data = $data;
    }
     ...
     */
    public function getData(): TokenResponseKonbiniData
    {
        return $this->data;
    }
     ...
     * @maps data
     */
    public function setData(TokenResponseKonbiniData $data): void
    {
        $this->data = $data;
    }

    /**
     * Converts the KonbiniTransactionToken object to a human-readable string representation.
     *
     * @return string The string representation of the KonbiniTransactionToken object.
     */
