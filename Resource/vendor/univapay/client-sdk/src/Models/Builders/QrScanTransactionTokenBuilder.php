...
/**
 * Builder for model QrScanTransactionToken
 *
 * @see QrScanTransactionToken
 */
class QrScanTransactionTokenBuilder
{
    /**
     * @var QrScanTransactionToken
     */
    private $instance;

    private function __construct(QrScanTransactionToken $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Qr Scan Transaction Token Builder object.
     *
     * @param TokenResponseQrScanData $data
     */
    public static function init(TokenResponseQrScanData $data): self
    {
        return new self(new QrScanTransactionToken($data));
    }
    ...
    /**
     * Initializes a new Qr Scan Transaction Token object.
     */
    public function build(): QrScanTransactionToken
    {
