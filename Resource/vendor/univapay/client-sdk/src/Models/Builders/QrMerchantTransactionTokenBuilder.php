...
/**
 * Builder for model QrMerchantTransactionToken
 *
 * @see QrMerchantTransactionToken
 */
class QrMerchantTransactionTokenBuilder
{
    /**
     * @var QrMerchantTransactionToken
     */
    private $instance;

    private function __construct(QrMerchantTransactionToken $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Qr Merchant Transaction Token Builder object.
     *
     * @param TokenResponseQrMerchantData $data
     */
    public static function init(TokenResponseQrMerchantData $data): self
    {
        return new self(new QrMerchantTransactionToken($data));
    }
    ...
    /**
     * Initializes a new Qr Merchant Transaction Token object.
     */
    public function build(): QrMerchantTransactionToken
    {
