...
class RefundListBuilder
{
    ...
    private function __construct(RefundList $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Refund List Builder object.
     */
    public static function init(): self
    {
        return new self(new RefundList());
    }
    ...
    /**
     * Initializes a new Refund List object.
     */
    public function build(): RefundList
    {
