...
/**
 * Builder for model DirectDebitBankTransfer
 *
 * @see DirectDebitBankTransfer
 */
class DirectDebitBankTransferBuilder
{
    /**
     * @var DirectDebitBankTransfer
     */
    private $instance;

    private function __construct(DirectDebitBankTransfer $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Direct Debit Bank Transfer Builder object.
     */
    public static function init(): self
    {
        return new self(new DirectDebitBankTransfer());
    }
    ...
    /**
     * Sets calculated debit date field.
     *
     * @param \DateTime|null $value
     */
    public function calculatedDebitDate(?\DateTime $value): self
    {
        $this->instance->setCalculatedDebitDate($value);
        return $this;
    }
     ...
     * @param string|null $value
     */
    public function lock(?string $value): self
    {
        $this->instance->setLock($value);
        return $this;
    }
    ...
    /**
     * Initializes a new Direct Debit Bank Transfer object.
     */
    public function build(): DirectDebitBankTransfer
    {
