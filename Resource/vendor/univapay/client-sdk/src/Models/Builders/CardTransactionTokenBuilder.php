...
/**
 * Builder for model CardTransactionToken
 *
 * @see CardTransactionToken
 */
class CardTransactionTokenBuilder
{
    /**
     * @var CardTransactionToken
     */
    private $instance;

    private function __construct(CardTransactionToken $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Card Transaction Token Builder object.
     *
     * @param TokenResponseCardData $data
     */
    public static function init(TokenResponseCardData $data): self
    {
        return new self(new CardTransactionToken($data));
    }
    ...
    /**
     * Initializes a new Card Transaction Token object.
     */
    public function build(): CardTransactionToken
    {
