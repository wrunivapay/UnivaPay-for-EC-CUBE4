...
/**
 * Builder for model PaidyTransactionToken
 *
 * @see PaidyTransactionToken
 */
class PaidyTransactionTokenBuilder
{
    /**
     * @var PaidyTransactionToken
     */
    private $instance;

    private function __construct(PaidyTransactionToken $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Paidy Transaction Token Builder object.
     *
     * @param TokenResponsePaidyData $data
     */
    public static function init(TokenResponsePaidyData $data): self
    {
        return new self(new PaidyTransactionToken($data));
    }
    ...
    /**
     * Initializes a new Paidy Transaction Token object.
     */
    public function build(): PaidyTransactionToken
    {
