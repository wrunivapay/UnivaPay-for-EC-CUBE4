...
/**
 * Builder for model TokenResponsePaidyDataShippingAddress
 *
 * @see TokenResponsePaidyDataShippingAddress
 */
class TokenResponsePaidyDataShippingAddressBuilder
{
    /**
     * @var TokenResponsePaidyDataShippingAddress
     */
    private $instance;

    private function __construct(TokenResponsePaidyDataShippingAddress $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Token Response Paidy Data Shipping Address Builder object.
     */
    public static function init(): self
    {
        return new self(new TokenResponsePaidyDataShippingAddress());
    }
    ...
    /**
     * Initializes a new Token Response Paidy Data Shipping Address object.
     */
    public function build(): TokenResponsePaidyDataShippingAddress
    {
