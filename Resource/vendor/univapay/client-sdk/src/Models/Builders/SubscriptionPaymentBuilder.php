...
/**
 * Builder for model SubscriptionPayment
 *
 * @see SubscriptionPayment
 */
class SubscriptionPaymentBuilder
{
    /**
    ...
    private function __construct(SubscriptionPayment $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Subscription Payment Builder object.
     */
    public static function init(): self
    {
        return new self(new SubscriptionPayment());
    }
    ...
    /**
     * Initializes a new Subscription Payment object.
     */
