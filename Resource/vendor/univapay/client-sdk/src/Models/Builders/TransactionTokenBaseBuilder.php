...
use UnivaPay\Models\TransactionTokenBase;

/**
 * Builder for model TransactionTokenBase
 *
 * @see TransactionTokenBase
 */
class TransactionTokenBaseBuilder
{
    /**
     * @var TransactionTokenBase
     */
    private $instance;

    private function __construct(TransactionTokenBase $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Transaction Token Base Builder object.
     */
    public static function init(): self
    {
        return new self(new TransactionTokenBase());
    }
    ...
    /**
     * Initializes a new Transaction Token Base object.
     */
    public function build(): TransactionTokenBase
    {
